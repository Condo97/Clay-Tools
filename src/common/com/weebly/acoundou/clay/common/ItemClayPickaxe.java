...
public class ItemClayPickaxe extends ItemClayTool
{
    ...
    public ItemClayPickaxe(int par1, EnumClayToolMaterial par2EnumClayToolMaterial)
    {
        super(par1, 2, par2EnumClayToolMaterial, blocksEffectiveAgainst);
    }
