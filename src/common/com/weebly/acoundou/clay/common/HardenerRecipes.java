...
{
    private static final HardenerRecipes hardeningBase = new HardenerRecipes();
     ...
     */
    public static final HardenerRecipes hardening()
    {
    ...
    private HardenerRecipes()
    {
        ...
        this.addHardening(Block.sand.blockID, new ItemStack(Block.sand));
