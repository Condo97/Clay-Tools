...
public class ItemHoeH extends Item
{
    protected EnumClayToolMaterial theToolMaterial;

    public ItemHoeH(int par1, EnumClayToolMaterial par2EnumClayToolMaterial)
    {
        super(par1);
        this.theToolMaterial = par2EnumClayToolMaterial;
        this.maxStackSize = 1;
